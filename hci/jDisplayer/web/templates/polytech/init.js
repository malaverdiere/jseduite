...
polytech.declare("tv_shows", new tv_shows_array(6), 1);
polytech.declare("weather", new weatherTransfo(),1);
polytech.declare("image_scraper", new imageScrapTransfo(),1);
polytech.declare("apal", new apal_array(5),1);
polytech.declare("picture_albums", new pictAlbumTransfo(),1);
polytech.declare("internal_news", new internalNews(),1);
polytech.declare("breaking_news", new breakingNews(),0);
polytech.declare("feed_reader",new feedHandler(),1);
polytech.declare("stud_summon", new studSummon(), 1);
polytech.declare("absences_profs", new absenceHandler(), 1);
polytech.declare("calendar", new iCalHandler(), 1);
polytech.declare("timetable", new edtHandler(), 1);
