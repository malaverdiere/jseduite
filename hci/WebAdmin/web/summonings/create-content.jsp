...
<f:subview id="content">
    <h1><h:outputText value="#{bundle.SUMMONINGS_CREATE}" /></h1>

    <h:form>
        <h:panelGrid columns="2" >
            <h:outputText value="#{bundle.SUMMONINGS_STUDENT}"/>
            <h:panelGroup>
                <h:inputText id="student" value="#{SummoningManagedBean.cSummoning.student}" required="true" requiredMessage="#{bundle.SUMMONINGS_STUDENT_REQUIRED}">
            ...
            <h:panelGroup>
                <h:inputText id="owner" value="#{SummoningManagedBean.cSummoning.owner}" required="true" requiredMessage="#{bundle.SUMMONINGS_OWNER_REQUIRED}">
            ...
            <h:selectOneMenu id="level" value="#{SummoningManagedBean.cSummoning.level}" required="true" requiredMessage="#{bundle.SUMMONINGS_LEVEL_REQUIRED}">
            ...
            <h:selectBooleanCheckbox value="#{SummoningManagedBean.cSummoning.valid}"/>
 
        </h:panelGrid>

        <h:commandButton value="#{bundle.FORM_OK}" action="#{SummoningManagedBean.create}"/>
