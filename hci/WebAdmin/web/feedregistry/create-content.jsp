...
<f:subview id="content">
    <h1><h:outputText value="#{bundle.FEEDREGISTRY_CREATE}" /></h1>

    <h:form id="form">
        <h:panelGrid columns="2" >
            <h:outputText value="#{bundle.FEEDREGISTRY_NICKNAME}"/>
            <h:panelGroup>
                <h:inputText id="nickname" value="#{FeedRegistryManagedBean.cFeed.nickname}" required="true" requiredMessage="#{bundle.FEEDREGISTRY_NICKNAME_REQUIRED}">
            ...
            <h:panelGroup>
                <h:inputText id="url" value="#{FeedRegistryManagedBean.url}" required="true" requiredMessage="#{bundle.FEEDREGISTRY_URL_REQUIRED}"/>
        ...
        <h:commandButton value="#{bundle.FORM_OK}" action="#{FeedRegistryManagedBean.create}"/>
