...
<f:subview id="content">
    <h1><h:outputText value="#{bundle.ABSENCES_UPDATE}" /></h1>

    <h:form>
        <h:panelGrid columns="2" >
            <h:outputText value="#{bundle.ABSENCES_TEACHER}"/>
            <h:panelGroup>
                <h:inputText id="teacher" value="#{AbsenceManagedBean.uAbsence.teacher}" required="true" requiredMessage="#{bundle.ABSENCES_TEACHER_REQUIRED}">
            ...
            <h:panelGroup>
                <h:inputText id="reason" value="#{AbsenceManagedBean.uAbsence.reason}" required="true" requiredMessage="#{bundle.ABSENCES_REASON_REQUIRED}">
                    <f:validateLength maximum="255" />
                </h:inputText>
        ...
        <h:commandButton value="#{bundle.FORM_OK}" action="#{AbsenceManagedBean.update}"/>
