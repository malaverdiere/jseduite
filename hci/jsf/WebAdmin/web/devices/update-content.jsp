...
<f:subview id="content">
    ...
    <h:form>
        ...
        <h:dataTable value="#{DeviceManagedBean.sources}" var="sourceData">
            <h:column>
                <h:panelGrid columns="1">
                    <h:outputText value="#{sourceData.source.name}" styleClass="subtitle"/>
                        ...
                        <h:column>
                            <h:panelGrid columns="1" styleClass="call">
                                ...
                                <h:dataTable value="#{callData.parameters}" var="paramData">
                                    <h:column>
                                        <h:outputText value="#{paramData.param.name}"/>
                                    </h:column>
                                    <h:column>
                                    ...
                                    <h:column>
                                        ...
                                        <h:outputText value="#{bundle.DEVICES_DEFAULT}#{paramData.param.defaultValue}"/>
                                    </h:column>
                                </h:dataTable>
                            </h:panelGrid>
                        </h:column>
                    ...
                    <h:panelGrid columns="1"  styleClass="callAddition">
                        <h:commandLink action="#{DeviceManagedBean.addition}" value="#{bundle.DEVICES_NEW_CALL}#{sourceData.source.name}" styleClass="title">
